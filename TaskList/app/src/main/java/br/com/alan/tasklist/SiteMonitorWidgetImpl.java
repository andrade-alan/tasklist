...
public class SiteMonitorWidgetImpl extends AppWidgetProvider {
    ...
    public static final String UPDATE_WIDGETS = "br.com.alan.tasklist.UPDATE_WIDGETS";
    ...
    public static void UpdateOneWidget(Context context,int widgetNumber) {
        ...
        if (smm != null) {
            ...
            cal.set(Calendar.DAY_OF_MONTH, PreferenciaHorario.obterDia(smm.getUrl()));
            cal.set(Calendar.MONTH, PreferenciaHorario.obterMes(smm.getUrl()));
            cal.set(Calendar.YEAR, PreferenciaHorario.obterAno(smm.getUrl()));

            long dias = 0;
            dias = cal.getTimeInMillis() - System.currentTimeMillis();
            ...
            else if(dias >= 259200000 && dias < 432000000) {
                views.setTextColor(R.id.siteName, Color.rgb(255, 140, 0));
                views.setTextColor(R.id.updateTime, Color.rgb(255, 140, 0));
                views.setTextColor(R.id.siteMessage, Color.rgb(255, 140, 0));
            }
            else{
            ...
            views.setTextViewText(R.id.updateTime, smm.getUrl());
            views.setTextViewText(R.id.siteMessage, smm.getHomepageUrl());

            // make this thing clickable
            Intent intWidgetClicked = new Intent(context,MainActivity.class);
